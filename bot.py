...
def get_info_message_text():
    return (
        ...
        f"• <b>نظام الإحالة:</b> شارك رابطك مع أصدقائك. عند دخول عضو جديد عبر رابطك وكتابته <b>{config.REFERRAL_REQUIRED_MESSAGES} رسالة</b> في المجموعة، يتم تفعيل إحالتك وتحصل على <b>+2 نقطة</b>.\n"
    ...
    if result['referral_activated'] and result['referrer_id']:
        ...
        try:
            ...
            await bot.send_message(
                ...
                f"تم احتساب الإحالة بنجاح وحصلت على <b>+2 نقطة</b>!\n"
